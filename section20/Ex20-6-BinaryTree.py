...
class BinaryTree:
    ...
    preorder_traversal((5), "") -> traversal = "5#"
        ...
        preorder_traversal((7), "5#3#2#4#") -> traversal = "5#3#2#4#7#"
            ...
            (7)2번  -> "5#3#2#4#7#6#8#"
                ...
                (8) 1번
                    preorder_traversal(None, "5#3#2#4#7#8#") -> traversal = "5#3#2#4#7#6#8#"
                (8) 2번
                    preorder_traversal(None, "5#3#2#4#7#8#") -> traversal = "5#3#2#4#7#6#8#"
    '''
    ...
    inorder_traversal((5), "")
        (5) 1번   -> "2#3#4#"
            inorder_traversal((3), "")
                ...
                inorder_traversal((2), "")
                    ...
                    (2) 2번
                        inorder_traversal(None, "") -> traversal = "2#"
        ...
        (5) 2번
            ...
            (7) 2번
                ...
                (8) 2번
                    inorder_traversal(None, "2#3#4#5#6#7#8#")
    ...
    def _insert(self, value, current_node):
        if value < current_node.value:
            if not current_node.left:  # current_node.left 값이 None이면 실행
